<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm avoid-page-break">
    ...
    {{-- Transaction Trend --}}
    <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm lg:col-span-2 avoid-page-break page-break-before">
